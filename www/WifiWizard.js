...
var WifiWizard = {
   ...
   */
    ...
    getSupplicantState: function(win, fail) {
        if (typeof win != "function") {
            console.log("getSupplicantState first parameter must be a function to handle SSID.");
            return;
        }
        cordova.exec(win, fail, 'WifiWizard', 'getSupplicantState', []);
    },
